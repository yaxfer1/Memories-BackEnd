...
import operator
import json
from typing import Annotated, List, TypedDict, Any, Union
...
# Configurar el API key de OpenAI
encoder = OpenAIEncoder(name="text-embedding-3-small")

# Inicializar Pinecone con API keys desde variables de entorno
...
def research_graph(query: str):
    try:
        ...
        out = {"intermediate_steps": [out["intermediate_steps"][-1]]}
    ...
    # Devuelve el JSON formateado con indentación para facilitar su lectura.
    return result_list
